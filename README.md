...
## Метрика качества
Для оценки качества модели в хакатоне использовалась метрика WMAE (Weighted Mean Absolute Error).
...
(Использование CatBoost с подобранными с помощью Optuna гиперпараметрами)
